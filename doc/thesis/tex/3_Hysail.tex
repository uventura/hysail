...
Um dos pontos necessários para garantir que a disponibilidade do HySail seja alta é o uso de códigos de erasure do tipo \emph{Online Codes},
...
Em termos de colisão, o protocólo garante que a probabilidade de dois blocos distintos produzirem o mesmo valor de
...
\section{Auditoria}%
HySail permite dois modelos de auditoria, bounded e unbounded. Em ambos, o cliente escolhe um polinômio
primitivo \(P_j(x)\) e verifica um subconjunto de blocos por meio de um desafio-resposta. No modelo bounded,
...
uma entidade confiável \(T\), e admite corrupção por fração limitada de blocos. A ideia é que um atacante pode
